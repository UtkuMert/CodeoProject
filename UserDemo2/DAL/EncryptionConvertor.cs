...
namespace UserDemo2.DAL
{
    ...
    {
        public EncryptionConvertor(string encryptionSecretKey)
        : base(
              x => Encrypt(x, encryptionSecretKey),
              x => Decrypt(x, encryptionSecretKey))
        { }
        ...
        public static void Apply(ModelBuilder builder, string encryptionSecretKey)
        {
            ...
            foreach (var property in properties)
            {
                ...
                {
                    property.SetValueConverter(new EncryptionConvertor(encryptionSecretKey));
                }
            }
        }
    }
